!(function (e, t) {
    ...
    function x(p, v) {
        ...
        function T(e) {
            ...
            I(), we(), w._input.value !== a && w._debouncedChange();
        }
        function I() {
        ...
        function N(e, t) {
            ...
            t && w.currentYear !== a && (ge("onYearChange"), J()),
                !t ||
        ...
        function H(e) {
            e.focus(), "range" === w.config.mode && ne(e);
        }
        function L(e) {
            for (
            ...
            var n = X(document.activeElement || document.body),
                a =
                    void 0 !== e
                        ...
                        : void 0 !== w.selectedDateElem && X(w.selectedDateElem)
                        ? w.selectedDateElem
                        : void 0 !== w.todayDateElem && X(w.todayDateElem)
                        ? w.todayDateElem
                        : L(t > 0 ? 1 : -1);
            void 0 === a
                ? w._input.focus()
        ...
        function K() {
            ...
            w.config.showMonths > 1 || "static" === w.config.monthSelectorType
                ...
                : ((w.monthsDropdownContainer = d(
                  ...
                  F(w.monthsDropdownContainer, "change", function (e) {
                      var t = g(e),
                          n = parseInt(t.value, 10);
                      w.changeMonth(n - w.currentMonth), ge("onMonthChange");
                  }),
                  J(),
            ...
            if (void 0 !== w.amPM && t === w.amPM)
                switch (e.key) {
                    ...
                    case w.l10n.amPM[0].charAt(0).toLowerCase():
                        (w.amPM.textContent = w.l10n.amPM[0]), I(), we();
                        break;
                    case w.l10n.amPM[1].charAt(0):
                    case w.l10n.amPM[1].charAt(0).toLowerCase():
                        (w.amPM.textContent = w.l10n.amPM[1]), I(), we();
                }
                ...
                for (
                    ...
                    Q(new Date(c), !0) ||
                        ...
                        c < n && (!r || c > r)
                            ? (r = c)
                            : c > n && (!l || c < l) && (l = c));
                for (var s = 0; s < w.config.showMonths; s++)
                    for (
                        var d = w.daysContainer.children[s],
                            u = function (a, i) {
                                var c,
                                    s,
                                    u,
        ...
        function ae() {
            !w.isOpen || w.config.static || w.config.inline || le();
        }
        function ie(e) {
            return function (t) {
                ...
                void 0 !== n &&
                    ...
                    w.selectedDates &&
                        ...
                        w.selectedDates.length || "min" !== e || S(n),
                        we()),
                    w.daysContainer &&
                        (ce(),
                        void 0 !== n
        ...
        function ce() {
            w.config.noCalendar || w.isMobile || (J(), ve(), B());
        }
        function se() {
            w._input.focus(),
                -1 !== window.navigator.userAgent.indexOf("MSIE") ||
            ...
            clickOpens: [
                function () {
                    !0 === w.config.clickOpens
                        ? (F(w._input, "focus", w.open),
                          F(w._input, "click", w.open))
        ...
        function ge(e, t) {
            if (void 0 !== w.config) {
                ...
                "onChange" === e &&
                    (w.input.dispatchEvent(pe("change")),
                    w.input.dispatchEvent(pe("input")));
            }
        }
        function pe(e) {
                ...
                void 0 !== w.mobileInput &&
                    ...
                    (w.mobileInput.value =
                        void 0 !== w.latestSelectedDateObj
                            ...
                            : ""),
                (w.input.value = De(w.config.dateFormat)),
                void 0 !== w.altInput &&
                    (w.altInput.value = De(w.config.altFormat)),
                    ...
                    (function () {
                        ...
                        i.altInputClass ||
                            (w.config.altInputClass =
                                oe().className + " " + w.config.altInputClass),
                            ge("onParseConfig");
                    })(),
                    re(),
                    (w.input = oe()),
                    ...
                    (function () {
                        if (
                            ...
                            !(function () {
                                ...
                                F(w.mobileInput, "change", function (e) {
                                    w.setDate(
                                        g(e).value,
                                        !1,
                                        w.mobileFormatStr
                            ...
                            if (
                                ...
                                !0 === w.config.clickOpens &&
                                    ...
                                    F(w._input, "click", w.open)),
                                void 0 !== w.daysContainer &&
                                    (F(w.monthNav, "click", be),
                                    F(w.monthNav, ["keyup", "increment"], O),
                                    F(w.daysContainer, "click", de)),
                                void 0 !== w.timeContainer &&
                                    void 0 !== w.minuteElement &&
                                    void 0 !== w.hourElement)
                            ) {
                                F(w.timeContainer, ["increment"], T),
                                    F(w.timeContainer, "blur", T, {
                                        capture: !0,
                                    }),
                                    F(w.timeContainer, "click", P),
                                    F(
                                    ...
                                    void 0 !== w.amPM &&
                                        F(w.amPM, "click", function (e) {
                                            T(e), A();
                                        });
                            }
                            w.config.allowInput && F(w._input, "blur", ee);
                        }
                    })(),
