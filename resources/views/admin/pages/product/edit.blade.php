                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="name" name="name" class="form-control" value="{{ $data->name }}" placeholder="Product Name" required data-validation-required-message="This name field is required">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="price" id="price" min="0" value="{{ $data->price }}" placeholder="Price" required data-validation-required-message="This price field is required">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="border rounded p-2">
                                            ...
                                            <div class="media flex-column flex-md-row">
                                                <div class="media-aside align-self-start">
                                                    <img src="{{ $data->image }}" alt="image" class="rounded mr-2 mb-1 mb-md-0" id="img_product" style="max-height: 100px; max-width: 150px; height: auto; width: 100%;">
                                                </div>
                                                <input type="hidden" name="temp_img" id="temp_img" value="{{$data->img_old}}">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="d-inline-block">
                                                        <div class="controls">
                                                            <input type="file" id="product_image" name="product_image" accept="image/*" class="form-control" placeholder="Image"/>
                                                        </div>
...
<script type="text/javascript">
    var description_product = <?= json_encode($data->description) ?>;
    ...
    $(document).ready(function() {
        ...
        editor[0].innerHTML = description_product;
